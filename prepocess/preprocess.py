...
directory_path = 'experiments/length_aware_data_augmentation/results'
...
def get_hetergeneous_mvc_item_embedding(args, num_epoch=5, embedding_dim=100):
    ...
    for dataset_name in args.datasets:
        ...
        save_path = f'experiments/length_aware_data_augmentation/results/embeddings/metapath2vec/{dataset_name}'
...
def main():
    ...
    parser.add_argument('--datasets', nargs='+', default= ['yoochoose1_64', 'Tmall', 'diginetica', 'Nowplaying'],

...
class Data():
    ...
    def get_slice(self, iList):
        ...
        # 메타 슬라이스
        session_ids_slice = self.session_ids[iList] if self.session_ids is not None else None
        is_original_slice = self.is_original_flags[iList] if self.is_original_flags is not None else None
        ...
        return alias_inputs, H, HT, G, EG, items, targets, node_masks, edge_mask, edge_inputs,  session_ids_slice, is_original_slice
